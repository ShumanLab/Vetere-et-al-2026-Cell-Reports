...
function [ csd, lfpAvg ] = bz_eventCSD_lv_forexamplefigs(lfp, events, animal, group, filter, csd_lyr_borders, region, varargin)
...
%lfp_avg = nanmean(lfp_temp,3)*-1;  %why flip sign??
