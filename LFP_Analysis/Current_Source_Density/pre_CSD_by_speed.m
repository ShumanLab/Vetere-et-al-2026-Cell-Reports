...
function [lfp, events, group, sex, age, channels_by_layer_csd, remove_chans_csd] = pre_CSD_by_speed(animal,filter, region, mins, maxs) 
%make data for CSD
%get lfp for best row of 21 channels 
%find channel assignments for each layer, bad channels
%to be removed for group analysis
%events = theta trough times 
